...
{
    return snd_pcm_close( ( snd_pcm_t *)( ( alsa_data_t *)alsa_data)->handle);
}
...
int write_to_alsa( void *alsa_data_ptr, uint32_t *buffer, unsigned long length)
{
    alsa_data_t *alsa_data = ( alsa_data_t *)alsa_data_ptr;
